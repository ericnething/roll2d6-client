...
module Chat.XMPP exposing (Command(..), connect, disconnect, encodeCommand, encodeSend, joinRoom, leaveRoom, sendMessage, showCommand, xmpp_send)

import Chat.Encode as Chat
import Chat.Types exposing (NewMessage, RoomConn)
import Json.Decode
...
encodeCommand command =
    case command of
        JoinRoom data ->
            Chat.encodeRoomConn data

        LeaveRoom data ->
            Chat.encodeRoomConn data

        SendMessage data ->
            Chat.encodeMessage data
