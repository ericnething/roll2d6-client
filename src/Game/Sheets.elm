...
fullSheetCard model =
    let
        ...
        { myPlayer, players, fullSheet, sheetModel, permissions } = model
...
editSheetToolbarView model =
    let
        ...
        { myPlayer, players, fullSheet, permissions } = model
    in
        div [ css
              [ Css.property "display" "grid"
...
toggleSwitchBlue : { offTitle : String
                   , onTitle : String
                   , isActive : Bool
                   , toMsg : (Bool -> msg)
                   }
